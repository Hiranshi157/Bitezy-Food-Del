...
const placeOrder=async(req,res)=>{
 ...
 const frontend_url= "https://bitezy-food-del-backend.onrender.com/";
    try {
        ...
        await newOrder.save();
        await userModel.findByIdAndUpdate(req.body.userId,{cartData:{}});//after place the order we need to clear users cart
...
const verifyOrder=async(req,res)=>{
    ...
    try {
        if(success=="true"){
            ...
            res.json({sccess:true,message:"Paid"})
        }
            else{
